          ...
          FutureBuilder(
            ...
            builder: (context,snapshot){
              if(snapshot.hasError){
                return Center(child: Image.asset(apiDomain().nodataimage.toString()),);
                          ...
                          title: Row(
                            ...
                            children: [
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text('${data['order_id']}',style: TextStyle(
                                        fontSize: 14,
                                        height: 0.9,
                                      ),),
                                    ],
                                  ...
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    children: [
                                      Text('Total Qty:  ',style: TextStyle(
                                        fontSize: 14,
                                        color: appcolor.redColor,
                                        height: 0.9,
                                      ),),
                              ...
                              Container(
                                width: 100,
                                decoration: BoxDecoration(
                                    color: data['status']=='cancelled'?appcolor.redColor:data['status']=='pending'?Colors.blueAccent:Colors.green,
                                    borderRadius: BorderRadius.all(Radius.circular(5))
                                ),
                                child: Padding(
                                  padding: const EdgeInsets.all(5.0),

                                  child: Center(child: Text('${data['status']=='cancelled'?'Cancelled':data['status']=='pending'?'Pending':'Confirm'}',style: TextStyle(fontWeight: FontWeight.w200,color: Colors.white),)),
                                ),
                              ),
                              // Column(
                              //   children: [
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text('${data['total_amount']}',style: TextStyle(
                                        fontSize: 14,
                                        height: 0.9,
                                      ),),
                                    ],
