                                  ...
                                  child: ListTile(
                                    title: Row(
                                      ...
                                      children: [
                                        Container(
                                            width: Get.width * 0.6,
                                            child: Text('${data['data']['title']}',style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold)  ,)),
                                        Text('${date2[2]}-${date2[1]}-${date2[0]}',style: TextStyle(fontSize: 12,color: appcolor.redColor),),
                                      ],
                                    ),
                                    subtitle: Row(
                                      ...
                                      children: [
                                        Container(
                                            width: Get.width * 0.6,
                                            child: Text('${data['data']['message'] == null ? '':data['data']['message']}',style: TextStyle(fontSize: 12,),maxLines: 2,)),
                                      ],
                                    ),
                                  ),
                                ),
