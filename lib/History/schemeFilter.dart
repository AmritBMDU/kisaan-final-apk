...
class schemeFilter extends StatefulWidget {
  ...
  final String url;
  final int conditon;
  const schemeFilter({super.key, this.startDate, this.enddate, required this.url, required this.conditon});

  @override
  State<schemeFilter> createState() => _transerFiler(startDate,enddate,url,conditon);
}
                          ...
                          children: [
                            TableRow(
                                ...
                                children :[
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text('Scheme',style: TextStyle(fontSize: 12,),textAlign:TextAlign.center),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                  ...
                                  children: [
                                    TableRow(
                                        ...
                                        children :[
                                          Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: Text('${date1[2]}-${date1[1]}-${date1[0]}',style: TextStyle(fontSize: 10,),textAlign:TextAlign.center),
                                          ),
                                          Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: Text('${data['scheme_name']}',style: TextStyle(fontSize: 10,),textAlign:TextAlign.center),
                                          ),
                                          Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: Text('${data['status']}',style: TextStyle(fontSize: 10,),textAlign:TextAlign.center),
                                          ),
                                          Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: Text('${data['point']}',style: TextStyle(fontSize: 10,),textAlign:TextAlign.center),
                                          ),
                                        ]),
                                    // TableRow(
                                    //     children :[
