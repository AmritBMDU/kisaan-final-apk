...
class transerFiler extends StatefulWidget {
  ...
  final String url;
  final int conditon;
  const transerFiler({super.key, this.startDate, this.enddate, required this.url, required this.conditon});

  @override
  State<transerFiler> createState() => _transerFiler(startDate,enddate,url,conditon);
}
                          ...
                          children: [
                            TableRow(
                                ...
                                children :[
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text('Amount',style: TextStyle(fontSize: 12,),textAlign:TextAlign.center),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                  ...
                                  children: [
                                    TableRow(
                                        ...
                                        children :[
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: Text('${data['amount']}',style: TextStyle(fontSize: 10,),textAlign:TextAlign.center),
                                          ),
                                          Padding(
                                            padding: const EdgeInsets.all(8.0),
