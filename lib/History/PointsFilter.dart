...
class PointsFiler extends StatefulWidget {
  ...
  final String url;
  final int conditon;
  const PointsFiler({super.key, this.startDate, this.enddate, required this.url, required this.conditon});

  @override
  State<PointsFiler> createState() => _PointsFilerState(startDate,enddate,url,conditon);
}
                                ...
                                children: [
                                  TableRow(
                                      ...
                                      children :[
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Text('${data['QR_Code']==null ?'':data['QR_Code'].length<7?"${data['QR_Code']}":'${data['QR_Code']}'.toString().substring(0,7)}..',style: TextStyle(fontSize: 14,),textAlign:TextAlign.center,softWrap: true,)
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
